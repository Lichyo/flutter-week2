...
class NoteService {
  final List<Note> _notes = [
    Note(title: '📌 Regularization Techniques in Deep Learning', description: 'Brief overview of L1, L2, and dropout to prevent overfitting.', dateTime: DateTime.now().subtract(const Duration(days: 1))),
    Note(title: '🧠 Difference Between Memory and Registers', description: 'Registers are faster and smaller; memory stores larger data.', dateTime: DateTime.now().subtract(const Duration(days: 2))),
